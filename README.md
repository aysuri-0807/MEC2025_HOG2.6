# MEC2025_HOG2.6  
*McMaster Engineering Competition 2025 | Programming Round #1*
...
├── Relief/ ― (Directory) Relief Module code 
├── SatelliteAI/ ― Satellite AI Module code/directory 
├── pycache/ ― (Python cache directory)
├── .gitignore
├── FireDetectionNN.pth ― Custom NN Trained weights 
